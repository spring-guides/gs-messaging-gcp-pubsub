...
:SpringApplication: https://docs.spring.io/spring-boot/{spring_boot_version}/api/java/org/springframework/boot/SpringApplication.html
...
https://docs.spring.io/spring-integration/reference/channel-adapter.html[Spring Integration channel adapters]
and
...
[source,xml,indent=0]
----
include::complete/pom.xml[tag=dependencies]
----

You also need to declare the Spring Cloud GCP bill of materials to control the versions of your dependencies:
...
or, programmatically, with the `PubSubAdmin` class.
